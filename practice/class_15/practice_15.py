...
def deliverables():
    ...
    plt.savefig('practice_15_r_vs_t.png')
    plt.savefig('practice_15_r_vs_t.pdf')
    ...
    plt.savefig('practice_15_r_vs_t_mex.png')
    plt.savefig('practice_15_r_vs_t_mex.pdf')
    plt.show(block=False)
    ...
    plt.legend()
    plt.title("Effect of Coolant Flow Rate (g/min)")
    plt.savefig('practice_15_T_vs_t.png')
