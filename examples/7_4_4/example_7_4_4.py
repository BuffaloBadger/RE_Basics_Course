"""Calculations for Example 7.4.4 from REB, The Book"""
...
def deliverables():
    ...
    print(results_df)
    print('')
    results_df.to_csv('example_7_4_4_results.csv', index=False)
    ...
    plt.savefig('example_7_4_4_net_rate_vs_coolant_flow.png')
    plt.savefig('example_7_4_4_net_rate_vs_coolant_flow.pdf')
    plt.savefig('../../../RE_Basics/solutions/ch7_ex4/example_7_4_4_net_rate_vs_coolant_flow.png')
    ...
    plt.xlim(left=0)
    plt.ylim(bottom = 0)
    plt.savefig('example_7_4_4_conversion_profile.png')
    plt.savefig('example_7_4_4_conversion_profile.pdf')
    plt.savefig('../../../RE_Basics/solutions/ch7_ex4/example_7_4_4_conversion_profile.png')
    plt.show(block=False)
    ...
    plt.xlim(left=0)
    plt.savefig('example_7_4_4_temperature_profile.png')
    plt.savefig('example_7_4_4_temperature_profile.pdf')
    plt.savefig('../../../RE_Basics/solutions/ch7_ex4/example_7_4_4_temperature_profile.png')
    plt.show()
