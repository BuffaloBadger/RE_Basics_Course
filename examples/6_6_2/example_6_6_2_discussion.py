"""Calculations for Discussion of Example 6.6.2 from REB, The Book"""

import example_6_6_2
import numpy as np
import pandas as pd
...
init_guess = np.array([example_6_6_2.nA_in, example_6_6_2.nB_in, 0.0, 0.0
            , example_6_6_2.T_in + 10.0])

# solve the design equations for a lower inlet temperature
example_6_6_2.T_in = 325 # K
solution = example_6_6_2.cstr_model_variables(init_guess)
...
fA = 100*(example_6_6_2.nA_in - nA)/example_6_6_2.nA_in
S_D_U = nD/nU
